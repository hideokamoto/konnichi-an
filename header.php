	...
	<header id="masthead" class="site-header mdl-layout__header mdl-layout__header--transparent" role="banner">
		<div class="mdl-layout__header-row">
			<?php if ( is_front_page() && is_home() ) : ?>
				<h1 class="mdl-layout-title"><a href="<?php echo esc_url( home_url( '/' ) ); ?>" rel="home"><?php bloginfo( 'name' ); ?></a><br/><small class="site-description"><?php bloginfo( 'description' ); ?></small></h1>
			<?php else : ?>
				<p class="mdl-layout-title"><a href="<?php echo esc_url( home_url( '/' ) ); ?>" rel="home"><?php bloginfo( 'name' ); ?></a><br/><small class="site-description"><?php bloginfo( 'description' ); ?></small></p>
			<?php endif; ?>
			<!-- .site-title -->
		</div>
	</header><!-- #masthead -->
